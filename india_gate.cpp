...
void mid() {
 ...
 // Left side arcs
 ellipse(935, 580, 90,180, 165, 105);
 ellipse(935, 580, 90,180, 185, 125);

 // Right Side Arcs
 ellipse(965, 580, 0,90, 165, 105);
 ellipse(965, 580, 0, 90, 185, 125);
...
void left() {
 // Left Base Rectangle
 rectangle(500, 700,700, 1000);

 // Lower Inner Rectangle
 rectangle(530, 700,670, 1000);
 rectangle(560, 920,640, 1000);
...
void right() {
 ...
 rectangle(1200, 700,1400, 1000);

 // Lower Inner Rectangle
 rectangle(1230, 700,1370, 1000);
 rectangle(1260, 920,1340, 1000);
