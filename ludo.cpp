...
int main() {
	...
	red_corner();  // Calling red_corner() Function

	blue_corner();  	// Calling blue_corner() Function

	green_corner();   	// Calling green_corner() Function

	yellow_corner();    // Calling yellow_corner() Function

	home();            // Calling home() Function

	line_red_blue();    	// Calling line_red_blue() Function

	line_green_yellow();   // Calling line_green_yellow() Function

	line_red_green();     // Calling line_red_green() Function

	line_yellow_blue();   	// Calling line_yellow_blue() Function
